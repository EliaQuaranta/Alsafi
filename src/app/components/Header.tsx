...
<div className="carousel carousel-center max-w-md p-2 space-x-4 bg-neutral rounded-box h-96">
...
<br />
<button className="text-5xl font-bold text-center font-link h-20">
        ...
        <p className="py-6 pt-10 font-link text-xl bg-[#2a4796] rounded-3xl ">Alsafi srls è un'agenzia di marketing e comunicazione altamente specializzata
...
mercato</p>
        <button className="btn btn-b-sky ">Prova ora</button>
      </div>
    </div>
  </div>
